...
const sampleInquiries = [
  ...
  { student: 'Anna Reyes', studentId: '2023-11890', email: 'anna.reyes@hau.edu.ph', message: "I keep getting ignored and no one in my block helps me. It's so frustrating.", category: 'Concern Report', status: 'negative', time: '8:30 AM' },
  { student: 'Mark Villanueva', studentId: '2021-03345', email: 'mark.villanueva@hau.edu.ph', message: 'How do I request a certificate of good moral character?', category: 'Document Request', status: 'neutral', time: '9:02 AM' },
  { student: 'Liza Fernandez', studentId: '2023-09988', email: 'liza.fernandez@hau.edu.ph', message: 'Can I book an appointment with a counselor this week?', category: 'Appointment', status: 'neutral', time: '9:18 AM' },
  { student: 'Carlo Ramirez', studentId: '2022-07712', email: 'carlo.ramirez@hau.edu.ph', message: "I've been feeling really anxious about my thesis defense and can't sleep.", category: 'Counseling', status: 'negative', time: '9:40 AM' },
];

const views = document.querySelectorAll('.view');

const settingsStorageKey = 'hau_dashboard_settings';
const appointmentsStorageKey = 'hau_dashboard_appointments';
...
const defaultAppointments = [
  { id: 1, date: '2026-06-27', time: '08:00', student: 'Maria Santos', status: 'reserved', notes: 'Academic counseling session' },
  { id: 2, date: '2026-06-27', time: '09:30', student: '', status: 'available', notes: 'Open for booking' },
  { id: 3, date: '2026-06-27', time: '11:00', student: 'John Dela Cruz', status: 'reserved', notes: 'Document request follow-up' },
  { id: 4, date: '2026-06-27', time: '13:30', student: '', status: 'available', notes: 'Open for booking' },
  { id: 5, date: '2026-06-27', time: '15:00', student: 'Anna Reyes', status: 'reserved', notes: 'Emotional support consultation' },
];
...
function saveAppointments(items) {
  try {
    localStorage.setItem(appointmentsStorageKey, JSON.stringify(items));
    return true;
  } catch (error) {
    console.error(error);
    return false;
...
function takeOverInquiry(inquiry) {
  ...
  window.location.href = 'chatbot_admin.html';
}
...
document.getElementById('save-entry-btn')?.addEventListener('click', () => {
  ...
  sampleInquiries.unshift({ student: name, studentId, email, message, category, status, time });
  renderAllTables();
  updateFlaggedCount();
